...
// Your fixed channels3Day array here
const channels3Day = [
...
const channels3Day = [
  ...
  // ... include ALL your remaining channels here
];
...
async function fetchFullEPG() {
  try {
    ...
    await fs.outputFile('epg_full_filtered.xml', finalXml);
    console.log('Full filtered EPG saved as epg_full_filtered.xml');
  } catch (err) {
    console.error('Error fetching full EPG:', err.message);
  }
}
