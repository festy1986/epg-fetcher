...
const SOURCES = {
    ...
    usfast: {
        ...
        days: 3,
        whitelist: [
            // Entire 24/7 list of channels you provided earlier
            ...
            "THE FBI","THE FIRST 48 BY A&E","THE GIRLS NEXT DOOR","THE INCREDIBLE DR. POL","THE JACK HANNA CHANN...",
            "THE MALLORCA FILES","THE MARTHA STEWART CHANNEL","THE NEW DETECTIVES","THE OSBOURNES","THE OUTER LIMITS",
            "THE OUTPOST","THE PRACTICE","THE PRICE IS RIGHT: DREW","THE PRICE IS RIGHT: THE BARKER YEARS",
            "THE REAL MCCOYS","THE REPAIR SHOP","THE RIFLEMAN","THE SAILOR MOON CHANNEL","THE THREE STOOGES +",
            "THE WALKING DEAD CHA...","THE WALKING DEAD UNIVERSE","THE YOUNG RIDERS","THIS OLD HOUSE",
            "THIS OLD HOUSE MAKERS...","TMNT","TO CATCH A SMUGGLER","TOP CHEF VAULT","TOP GEAR","TRAILER PARK BOYS",
...
async function fetchAndParse(provider) {
    ...
    const buffer = await axios.get(src.url, { responseType: 'arraybuffer' }).then(r => r.data);
